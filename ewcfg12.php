...
>>>>>>> 01cd2d760bc517d78003601698aa8e1eb1c58a9e
...
$EW_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "dadores_de_sangre", "qs" => "`", "qe" => "`");
