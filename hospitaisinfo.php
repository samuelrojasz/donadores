...
//
// Table class for hospitais
//
class chospitais extends cTable {
	var $Id;
	var $nome;
	var $endereco;
	var $telefone;
	...
	function __construct() {
		...
		$this->TableVar = 'hospitais';
		$this->TableName = 'hospitais';
		$this->TableType = 'TABLE';

		// Update Table
		$this->UpdateTable = "`hospitais`";
		$this->DBID = 'DB';
		$this->ExportAll = TRUE;
		...
		// Id
		$this->Id = new cField('hospitais', 'hospitais', 'x_Id', 'Id', '`Id`', '`Id`', 3, -1, FALSE, '`Id`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		$this->Id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['Id'] = &$this->Id;

		// nome
		$this->nome = new cField('hospitais', 'hospitais', 'x_nome', 'nome', '`nome`', '`nome`', 200, -1, FALSE, '`nome`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['nome'] = &$this->nome;

		// endereco
		$this->endereco = new cField('hospitais', 'hospitais', 'x_endereco', 'endereco', '`endereco`', '`endereco`', 200, -1, FALSE, '`endereco`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['endereco'] = &$this->endereco;

		// telefone
		$this->telefone = new cField('hospitais', 'hospitais', 'x_telefone', 'telefone', '`telefone`', '`telefone`', 200, -1, FALSE, '`telefone`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['telefone'] = &$this->telefone;

		// celular
		$this->celular = new cField('hospitais', 'hospitais', 'x_celular', 'celular', '`celular`', '`celular`', 200, -1, FALSE, '`celular`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['celular'] = &$this->celular;

		// estado
		$this->estado = new cField('hospitais', 'hospitais', 'x_estado', 'estado', '`estado`', '`estado`', 200, -1, FALSE, '`estado`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		$this->fields['estado'] = &$this->estado;

		// cidade
		$this->cidade = new cField('hospitais', 'hospitais', 'x_cidade', 'cidade', '`cidade`', '`cidade`', 200, -1, FALSE, '`cidade`', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	function getSqlFrom() { // From
		return ($this->_SqlFrom <> "") ? $this->_SqlFrom : "`hospitais`";
	}
	...
	function GetViewUrl($parm = "") {
		if ($parm <> "")
			$url = $this->KeyUrl("hospitaisview.php", $this->UrlParm($parm));
		else
			$url = $this->KeyUrl("hospitaisview.php", $this->UrlParm(EW_TABLE_SHOW_DETAIL . "="));
	...
	function GetAddUrl($parm = "") {
		if ($parm <> "")
			$url = "hospitaisadd.php?" . $this->UrlParm($parm);
		else
			$url = "hospitaisadd.php";
		return $this->AddMasterUrl($url);
	}

	// Edit URL
	function GetEditUrl($parm = "") {
		$url = $this->KeyUrl("hospitaisedit.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetCopyUrl($parm = "") {
		$url = $this->KeyUrl("hospitaisadd.php", $this->UrlParm($parm));
		return $this->AddMasterUrl($url);
	}
	...
	function GetDeleteUrl() {
		return $this->KeyUrl("hospitaisdelete.php", $this->UrlParm());
	}
